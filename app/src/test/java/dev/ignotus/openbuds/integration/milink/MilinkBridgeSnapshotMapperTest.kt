...
class MilinkBridgeSnapshotMapperTest {
    ...
    fun fromUiState_mapsBatteryWearingAndCharging() {
        ...
        assertEquals(1, snapshot.formFactor)
        ...
        assertNull(snapshot.currentVolume)
        assertEquals(0, snapshot.currentAudioEffectState)
        ...
        assertEquals(true, snapshot.supportsAudioEffect)
